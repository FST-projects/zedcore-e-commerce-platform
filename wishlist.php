        ...
        <body style="background-color: rgb(245, 245, 245);">
            ...
            <div style="padding-left: 20px; margin-top: 10px;">
                <div class="ui breadcrumb">
                    ...
                    <div class="active section">My Wishlist</div>
                </div>
            </div>

            <?php

            $user_wish_rs = Database::search("SELECT * FROM `wishlist` WHERE `userwish_id` = '" . $email . "'");
            ...
            <div class="ui container segment" style="min-height: 55vh; padding: 0; padding-bottom: 50px; box-shadow: rgba(0, 0, 0, 0.2) 0px 18px 50px -10px; position: relative;">
                <div class="wishtop">
                    <span class="wishtoptxt1">My Wishlist</span>
                    <div style="display: flex;">
                        <span id="numrow" class="wishtoptxt2"><?php echo $user_wish_rs->num_rows ?></span>
                ...
                <div class="wishContent">
                    ...
                    if ($user_wish_rs->num_rows > 0) {
                        for ($x = 0; $user_wish_rs->num_rows  > $x; $x++) {
                            $user_wish_data = $user_wish_rs->fetch_assoc();

                            $product_details_rs = Database::search("SELECT * FROM `product` WHERE `id` = '" . $user_wish_data['wish_p_id'] . "' ");
                            $product_details = $product_details_rs->fetch_assoc();

                            $product_img_rs = Database::search("SELECT * FROM `product_img` WHERE `product_id` = '" . $user_wish_data['wish_p_id'] . "'");
                    ...
                    ?>
                                <div class="wishProduct d-flex" id="pbox<?php echo $product_details['id'] ?>">
                                    ...
                                    <div class="wishdetails">
                                        ...
                                        <div class="WishBtnBox">
                                            ...
                                            <div class="btnBox">
                                                <button class="fred wishBtn wishbtn2" onclick="addToCart(<?php echo $user_wish_data['wish_p_id']; ?>);">
                                                    Add to Cart
                                                </button>
                                                <button id="cls<?php echo $product_details['id'] ?>" class="fred wishBtn wishbtn1" onclick="removeProd(<?php echo $user_wish_data['wish_p_id']; ?>);">
                                                    Remove
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="wishProduct d-flex" id="pbox<?php echo $product_details['id'] ?>">
                                    ...
                                    <div class="wishdetails">
                                        ...
                                        <div class="WishBtnBox">
                                            ...
                                            <div class="btnBox">
                                                <button class="fred wishBtn disble">
                                                    Add to Cart
                                                </button>
                                                <button id="cls<?php echo $product_details['id'] ?>" class="fred wishBtn wishbtn1" onclick="removeProd(<?php echo $user_wish_data['wish_p_id']; ?>);">
                                                    Remove
                            ...
                            <center>
                                <div id="emtcart" class="d-none" style="padding-top: 30px; padding-bottom: 40px;">
                                    <div>
                                        <img src="resourses/wish.svg" class="statimg" alt="">
                                    </div>
                                    <br>
                                    <span class="statfontz">No Wishes Yet?</span>
                                </div>
                            </center>
                        <?php
                        }
