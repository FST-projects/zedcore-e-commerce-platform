...
<head>
    ...
    <title>Zedcore | Contact Us</title>
...
<body style="background-color: rgb(245, 245, 245);">
    ...
    <div class="contactMainHolder" style="margin-top: 40px; margin-bottom: 45px;">
        <div class="contactImg">
            <img src="resourses/Custumer_Service.jpg" alt="">
        </div>
        <div class="contactDetailBox">
            <div class="contactText">
                Contact Zedcore <br> Just in Click
            </div>
            <div class="contactBtnArea" style="flex-direction: column;">
                <button class="ContactBtn" style="margin-bottom: 40px;" onclick="window.location='chat.php'">Start Chat</button>
                <div>
